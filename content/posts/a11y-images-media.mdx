---
title: "تصاویر و رسانه (Images & Media)"
date: "2026-09-21"
playlist: "چک لیست: دسترسی پذیری"
tags:
  ["a11y", "Accessibility", "Images", "Media", "WCAG", "alt-text", "Captions"]
...
<figure>
  ...
  <figcaption>
    فروش در فروردین ۱۲۰ میلیون، اردیبهشت ۱۵۰ میلیون و خرداد ۱۸۰ میلیون تومان
    بوده.
  </figcaption>
</figure>
```
